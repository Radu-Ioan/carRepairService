...
describe('Car e2e test', () => {
  ...
  const carSample = { ownerName: 'coarse' };
  ...
  describe('new Car page', () => {
    ...
    it('should create an instance of Car', () => {
      cy.get(`[data-cy="company"]`).type('that player');
      cy.get(`[data-cy="company"]`).should('have.value', 'that player');

      cy.get(`[data-cy="manufacturedYear"]`).type('4835');
      cy.get(`[data-cy="manufacturedYear"]`).should('have.value', '4835');

      cy.get(`[data-cy="ownerName"]`).type('than excepting underwrite');
      cy.get(`[data-cy="ownerName"]`).should('have.value', 'than excepting underwrite');
