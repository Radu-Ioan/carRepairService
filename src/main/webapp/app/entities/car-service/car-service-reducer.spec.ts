...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARSERVICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARSERVICE actions', async () => {
      const expectedActions = [
        {
