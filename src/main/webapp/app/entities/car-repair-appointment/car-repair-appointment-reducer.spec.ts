...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './car-repair-appointment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARREPAIRAPPOINTMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARREPAIRAPPOINTMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARREPAIRAPPOINTMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARREPAIRAPPOINTMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARREPAIRAPPOINTMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARREPAIRAPPOINTMENT actions', async () => {
      const expectedActions = [
        {
