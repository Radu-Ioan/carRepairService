...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './car-service-employee.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARSERVICEEMPLOYEE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARSERVICEEMPLOYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARSERVICEEMPLOYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARSERVICEEMPLOYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARSERVICEEMPLOYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARSERVICEEMPLOYEE actions', async () => {
      const expectedActions = [
        {
